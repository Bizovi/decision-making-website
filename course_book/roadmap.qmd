...
- [**Module IIb**](#module-iib-hypotheses-and-ab-testing): Hypothesis Formulation and A/B Testing[^r3]
- [**Module IIc**](#module-iic-causal-inference-with-dags): Causal Inference with Directed Acyclic Graphs
...
## Module IIc: Causal Inference with DAGs

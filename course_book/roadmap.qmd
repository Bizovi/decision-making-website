...
### A possible schedule of one hour lectures

::: {.column-page-inset-right}

| Week  | Title                      | Keywords  | Case Studies |
|------|-----------------------|---------------|--------------|
| W1 (L1) | Data Science in Business Context. Decision-Making Under Uncertainty at Scale | AI, ML, Uncertainty, Decisions  | survey of applications in various domains |
| W1 (L2) | Interdisciplinarity. Why did you study all of that? Overview of prerequisites.| Calculus, Linear Algebra, Probability, Stats, Economics | survey of interest and assessment of students' skills  |
| W1 (L3) | Business Analyst's Workflow. Newsvendor Problem and em' tradeoffs. Analytics vs Stats vs ML | action, outcome, strategy, expertise, data, models, simulation, DAGs | TIME INC. printing quantity decisions |
| W1 (L4) | Strategy and the Desired Trajectory | SWOT, Systems Dynamics, KPIs, Stock vs Flow | LRB Journal Subscriptions |
| *W1 (L6)* | Probability Triple. Random Variables. Mathematical Statistics | population, sample, r.v., estimators, mixtures, markov chain | Retail Fashion - appropriate choice of distributions  |
| W1 (L5) | Newsvendor Problem. Probability distributions. Stochastic Processes | model specification, inference, simulation, optimization, constraints | groceries and perisable goods |
| *W1 (L7)* | The most dangerous equation | estimators properties, CLT, sample size | U.S. small schools and top SAT Scores |
| *W1 (L8)* | LLN, CLT, Asymptotics and Exact Criteria | $\chi^2_k, N, F_{m, n}, t_k$ | Delta method  |
| **W2 (L9)** | Reproducible Research | automation, code, data, environment, documents, publishing | Replication crisis, Excel and the Dead Salmon |
| **W2 (L10)** | Set Up the Environment. Overview of Data. Version the Code  | Command Line, R, RStudio, Renv, Python, JupyterLab, Quarto, github, RStudio, kaggle | Tooling choice and DevExperience impact on productivity |
|**W2 (L11)** | Tidyverse warm-up | dplyr, ggplot2, quarto, renv projects, rendering | Tiny Sleep dataset tidy data wrangling  |
| W2 (L12) | 12 Steps of ML. What is ML?  | PAC Learning, generalization, CRISP-DM | Project requirements simplification |
| W2 (L13) | 12 Steps of Statistics. A/B Testing Scheme | Default Action, Stat. Hypotheses, confidence intervals, relevance | problem of p-value |
| **W2 (L14)** | Practice: tidyverse data wrangling | \*** | Movie Data |
| **W2 (L15)** | Practice: ggplot data visualization | \*** | Covid infections, Geographical data |
| W2 (L16) | Bayes Rule | DAGs, Conditioning, Marginalization | Football Spreads, Medical testing |

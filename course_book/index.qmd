...
I believe that improving **decision-making** is the reason why we practice AI. We mostly forgot that as teachers. We're also getting increasingly specialized -- which makes us miss the interdisciplinary, big picture.
:::
...
In statistics' classes, the problem is usually completely framed. Experiment design in practice is fascinating and complicated, full of pitfalls and dangers. That's not your stats 101!
:::
...
- [**Module 2b**](02_causality/roadmap_abtest.qmd): Hypothesis Formulation and A/B Testing
...
The good news is that you can safely use the curated resources and suggested practices!
:::

...
::: {.column-margin}
![**Mihai Bizovi** | Head of Data Science \@AdoreMe](01_fundamentals/img/bizovi-pic-website.jpeg "Portrait"){width="60%"}
:::
...
- [**Module 1**](01_fundamentals/roadmap.qmd): Business School for Data Scientists
- [**Module 2**](01_fundamentals/stat_foundations.qmd): The Fundamentals of Probability and Statistics
- [**Module 3**](references.qmd): Applied Bayesian Statistics




**My preferred sequence** is to go in parallel with the "business school" and the fundamentals of probability and statistics. I call it business school, because it's at the intersection of business economics and data science -- focused on the process (of ML, statistics) and not so much on content, focused on the problem and not so much on solutions.
...
Thus, we acknowledged the limitations of inferring an association, so it's time to get more powerful tools from **causal inference**. It will enable us to extract new insights from natural experiments and observational data. Causal inference requires deep thinking and understanding, which is truly challenging -- it is an art and science, in contrast with the auto-magic pattern recognition of ML. 

...
- Demand planning, inventory optimization, and production
...
How many times have you heard that correlation doesn't imply causation?
:::


- Theory $\longrightarrow$ Causal Model + Data $\longrightarrow$ New insight
- You can't derive a theory using data alone
- Causal Inference is harder than ML and "curve fitting"
- You want to know the consequences of your intervention
- Advanced topic which we won't cover in the course

...
- Understand how and why the theory works by doing lots of simulations. Find out under what conditions it fails. In the section ["simulation of economic processes"](/sim/1_intro.qmd), I explain multiple ways in which simulation and numerical methods are used in practice.
...
- Rohan - [Telling Stories with data](https://tellingstorieswithdata.com/) has excellent chapters on modeling workflow and writing researchc
...
flowchart TD
    ...
    U[Uncertainty] -- P. construction --> Comb[Combinatorics] --> PTr[Prob Triple, r.v.] --> RV[Distribution stories] --> B[Bayes & Conditioning]

    U -- estimator properties --> E[LLN, CLT, Properties] --> BV[Bias-Variance]

    U -- hypothesis testing --> NP[Neyman-Pearson] --> M1[/Module 1: A/B Testing/] --> Persp[Freq, Lik, Bayes] --> RC[Replication Crisis]

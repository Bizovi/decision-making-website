...
|   | Lecture                       | Keywords  | Case Studies / Activities |
|-|-------------------------------------|-----------|---------------------------|
| 1 | [Introduction](../index.qmd) & Course Overview | Decisions, Modeling, VUCA, [Prerequisites](prerequisites.qmd), Project requirements, Course philosophy  | survey of applications and domains, purpose of a business |
| 2 | [Decision-Making Under Uncertainty at Scale](background.qmd) | AI, Cybernetics, Analytics vs Stats vs ML, Interdisciplinarity, Uncertainty  | data roles, Uber and dynamic pricing, danger of buckets |
| 3 | [Data Science in Business Context](2_performance_strategy.qmd) | Diagnosis, Strategy, Business Analyst's Workflow, Value Chain, Fermi Estimation  | case-studies: LRB subscriptions, DTC fashion e-commerce |
| 4* | **Newsvendor Problem** and Demand Planning  | Probability DAGs, model choice, inference, optimization with constraints | TIME INC. printing, simulations, restaurant data (ddop) |
...
I prefer to fill in the gaps with **stories** and **simulations**, however, in some cases the mathematical formalism and abstractions can't be avoided and actually helps understanding

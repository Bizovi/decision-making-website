...
We can pick a (seemingly) simpler use-case like housing prices prediction, credit default, churn, demand forecasting, or recommender systems -- and show how training and prediction look like in code.

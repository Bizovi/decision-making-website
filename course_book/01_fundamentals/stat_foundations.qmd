...
We stumble upon different interpretations of probability (frequentists vs bayesians), when trying to clarify that "perceptible regularity", despite the mathematics of probability theory being exactly the same. These are not "theorems" to prove, but rather axioms and philosophies taken as the starting point.

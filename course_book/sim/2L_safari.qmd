...
subtitle: "Bernoulli, probability trees, and LLN"
author:
  - name: Mihai Bizovi
    id: mb
    degrees: 
...
Laws of large numbers is a set of results in probability theory which justifies the Monte-Carlo approach to simulation and "makes it work". You saw the simplest example of it when we discussed statistical stability and Bernoulli's theorem in the context of probability triple.^[In the next weeks we will get the remaining tools: The Universality of Uniform and Central Limit Theorem]
